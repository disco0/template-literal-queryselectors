...
{
    querySelector<T extends string>(selector: T):    MatchEachElement<GetElementNames<T>>;
    querySelectorAll<T extends string>(selector: T): HTMLCollectionOf<Exclude<MatchEachElement<GetElementNames<T>>, null>>;
}

//#endregion Bind signatures to DOM methods
